...
import { useGetProductsQuery, useDeleteProductMutation, useBuyProductMutation, useRentProductMutation } from "@/shared/redux/rtk-apis/products/products.api";
...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/shared/components/shadui/select";
...
const ProductsContainer = () => {
    ...
    const columns: ColumnDef<IProduct>[] = [
        ...
        },
        {
            accessorKey: "owner",
            header: "Owner",
            cell: ({ row }) => row.original.owner?.firstName ? `${row.original.owner.firstName} ${row.original.owner.lastName}` : "Unknown",
        },
        {
            id: "actions",
            header: "Actions",
